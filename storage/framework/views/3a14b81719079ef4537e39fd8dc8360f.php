                                            ...
                                            <form
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <input type="hidden" name="user" class="form-control"
                                                        id="user" value="<?php echo e($items->pembelian_user_id); ?>" />
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Thrift_App\Thrift_App\resources\views/web/data/data_pembelian.blade.php ENDPATH**/ ?>