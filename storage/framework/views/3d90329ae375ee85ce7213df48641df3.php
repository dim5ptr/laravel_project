...
<?php $__env->startSection('main'); ?>
    ...
    <div class="container-flex text-center pt-3 pb-3" style="background: #994D1C">
        ...
        <div class="text-bg-dark p-2">
            <?php if($user->user_profil_url === '' || $user->user_profil_url === null): ?>
                <img width="150px" height="150px" src="<?php echo e(asset('img/profil.jpg')); ?>"
        ...
        <?php if($user->user_id): ?>
            ...
            <?php $__currentLoopData = $paymentMethods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $method => $imageName): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <label style="width: 200px" class="card text-bg-light p-2">
                    ...
                    <button class="m-2 btn btn-<?php echo e($hasPaymentMethod ? 'warning' : 'primary'); ?>" type="button"
                        ...
                        <div class="modal-content">
                            ...
                            <form action="<?php echo e($formAction); ?>" method="post">
                                ...
                                <div class="modal-footer">
                                    <button type="submit"
                                        class="btn btn-<?php echo e($hasPaymentMethod ? 'warning' : 'primary'); ?>"><?php echo e($hasPaymentMethod ? 'Ubah' : 'Simpan'); ?></button>
                                </div>
                            </form>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Thrift_App\Thrift_App\resources\views/web/view/profil.blade.php ENDPATH**/ ?>