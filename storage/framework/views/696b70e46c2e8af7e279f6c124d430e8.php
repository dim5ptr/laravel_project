        ...
        <main>
            <fieldset>
                <form action="<?php echo e(route('action.create_data_pakaian')); ?>" method="post">
                    <?php echo csrf_field(); ?>
                    <input type="text" name="kategori" placeholder="kategori" value="1">
                    <input type="text" name="nama" placeholder="nama">
                    <input type="text" name="harga" placeholder="harga">
                    <input type="text" name="stok" placeholder="stok">
                    <input type="text" name="status" placeholder="status" value="1">
...
</html><?php /**PATH D:\Belajar\Laravel\Thrift_App\resources\views/web/view/data_pakaian.blade.php ENDPATH**/ ?>