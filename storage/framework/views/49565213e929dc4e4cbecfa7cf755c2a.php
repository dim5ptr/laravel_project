...
<nav class="navbar shadow-xl navbar-expand-lg" style="background-color: #994D1C;">
    <div class="container-fluid">
        <a class="navbar-brand" href="<?php echo e(route('dashboard')); ?>"><img width="90px" src="<?php echo e(asset('img/logo.png')); ?>"></a>
...
<?php /**PATH D:\Thrift_App\Thrift_App\resources\views/layouts/nav.blade.php ENDPATH**/ ?>